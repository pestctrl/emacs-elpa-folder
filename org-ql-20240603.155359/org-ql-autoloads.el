...
\(fn BUFFERS-FILES &key QUERY-PREFIX QUERY-FILTER (ACTION #\\='org-ql-completing-read-action) (SNIPPET #\\='org-ql-completing-read-snippet) (PATH #\\='org-ql-completing-read-path) (ACTION-FILTER #\\='list) (PROMPT \"Find entry: \"))" nil nil)
...
\(fn BUFFERS-FILES &key QUERY-PREFIX QUERY-FILTER (PROMPT \"Open link: \"))" t nil)
