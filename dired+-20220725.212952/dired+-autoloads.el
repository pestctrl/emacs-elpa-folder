;;; dired+-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(defvar diredp-case-fold-search (if (boundp 'recentf-case-fold-search) recentf-case-fold-search (memq system-type '(windows-nt cygwin))) "\
Non-nil means some Dired+ functions ignore case.
The doc of such functions calls out the use of this option.")
(custom-autoload 'diredp-case-fold-search "dired+" t)
...
(defvar diredp-default-sort-arbitrary-function nil "\
...
(custom-autoload 'diredp-default-sort-arbitrary-function "dired+" t)
...
(defvar diredp-omit-lines-regexp nil "\
...
* `dired-re-no-dot'
* `diredp-re-no-dot'")
(custom-autoload 'diredp-omit-lines-regexp "dired+" t)
...
(defvar diredp-switches-in-mode-line nil "\
...
(custom-autoload 'diredp-switches-in-mode-line "dired+" t)
(defvar diredp-toggle-dot+dot-dot-flag t "\
Non-nil means `dired-toggle-marks' acts also on `.' and `..'.")
(custom-autoload 'diredp-toggle-dot+dot-dot-flag "dired+" t)
...
(fn STRING &optional READ-EXTRA-FILES-P DIRED-BUFFER)")
...
Insert thumbnails before file names of marked files in the Dired buffer." t)
...
Add comment to this image file." t)
(autoload 'diredp-image-dired-tag-file "dired+" "\
Tag this image file with an `image-dired' tag." t)
(autoload 'diredp-image-dired-delete-tag "dired+" "\
Remove an `image-dired' tag from  this image file." t)
...
Uses `image-dired-get-exif-file-name' to name the new file." t)
(autoload 'diredp-image-dired-edit-comment-and-tags "dired+" "\
Edit comment and tags for this image file." t)
...
(fn CMD-NAME DIRECTORY &optional FILES MSG-P)" t)
...
(fn BUFFER &optional ARG FILES)" t)
...
In Dired, add this file to the list of recently used files." t)
(autoload 'diredp-remove-this-from-recentf "dired+" "\
In Dired, remove this file from the list of recently used files." t)
...
(fn &optional FILE INTERACTIVEP)" t)
...
(fn &optional FILE INTERACTIVEP)" t)
(autoload 'diredp-sort-arbitrary-command "dired+" "\
...
(fn DIRED-NAME DIRBUFS &optional SWITCHES EXTRA)" t)
...
(fn DIRED-NAME TO-ADD &optional SWITCHES)" t)
...
(fn &optional ARG PREDICATE INTERACTIVEP DETAILS)" t)
...
(fn &optional DIR NO-CONFIRM-P DETAILS)" t)
...
(fn &optional SWITCHES INTERACTIVEP)" t)
...
(fn &optional IGNORE-MARKS-P DETAILS)" t)
...
(fn COMMAND &optional IGNORE-MARKS-P DETAILS)" t)
...
(fn &optional IGNORE-MARKS-P APPEND DO-NOT-POP DETAILS)" t)
...
(fn &optional IGNORE-MARKS-P PREFIX DETAILS)" t)
...
(fn IGNORE-MARKS-P &optional DETAILS MSGP)" t)
...
(fn BOOKMARK-FILE &optional PREFIX IGNORE-MARKS-P BFILE-BOOKMARKP DETAILS)" t)
...
(fn BOOKMARK-FILE &optional PREFIX IGNORE-MARKS-P DETAILS)" t)
...
(fn FROM TO &optional ARG DETAILS)" t)
...
(fn COMMAND-ARGS &optional DETAILS)" t)
...
(fn DIRNAME &optional IGNORE-MARKS-P DETAILS)" t)
...
(fn &optional IGNORE-MARKS-P PREDICATE DETAILS)" t)
...
(fn REGEXP &optional MARKER-CHAR IGNORE-MARKS-P DETAILS)" t)
...
(fn &optional IGNORE-MARKS-P DETAILS)" t)
(autoload 'diredp-do-aggregate-apply-to-marked-recursive "dired+" "\
...
(fn AGGREGATE-FUN APPLY-FUN &optional IGNORE-MARKS-P DETAILS MSGP)" t)
(autoload 'diredp-do-aggregate-eval-in-marked-recursive "dired+" "\
...
(fn AGGREGATE-FUN SEXP &optional IGNORE-MARKS-P DETAILS MSGP)" t)
(autoload 'diredp-do-apply-to-marked-recursive "dired+" "\
...
(fn FUNCTION &optional IGNORE-MARKS-P DETAILS)" t)
(autoload 'diredp-do-command-in-marked-recursive "dired+" "\
...
(fn COMMAND &optional ARG DETAILS)" t)
(autoload 'diredp-do-eval-in-marked-recursive "dired+" "\
...
(fn SEXP &optional IGNORE-MARKS-P DETAILS)" t)
(autoload 'diredp-do-apply/eval-marked-recursive "dired+" "\
...
(fn FUN/SEXP &optional ARG DETAILS)" t)
...
(fn &optional DETAILS MSGP)" t)
(autoload 'diredp-change-ls-switches "dired+" "\
...
(fn DIRNAME &optional ARG SWITCHES)" t)
...
(fn EXTENSION &optional UNMARK-P)" t)
...
(fn TAGS &optional NONE-P PREFIX)" t)
...
(fn TAGS &optional ALLP PREFIX)" t)
...
(fn TAGS &optional SOMENOTP PREFIX)" t)
...
(fn TAGS &optional SOMEP PREFIX)" t)
...
(fn REGEXP &optional NOTP PREFIX)" t)
...
(fn TAG VALUE &optional PREFIX ARG)" t)
...
Mark all autofiles, that is, files that have an autofile bookmark." t)
(autoload 'diredp-unmark-autofiles "dired+" "\
Unmark all autofiles, that is, files that have an autofile bookmark." t)
...
(fn BOOKMARK-FILE &optional PREFIX ARG)" t)
...
(fn BOOKMARK-FILE &optional PREFIX ARG BFILE-BOOKMARKP FILES)" t)
...
(fn EVENT &optional FIND-FILE-FUNC FIND-DIR-FUNC)" t)
...
(fn FORCE-P)" t)
(autoload 'diredp-create-file-here "dired+" "\
...
Omit lines of marked files.  Return the number of lines omitted." t)
(autoload 'diredp-omit-unmarked "dired+" "\
Omit lines of unmarked files.  Return the number of lines omitted." t)
...
(fn FILE2)" t)
(autoload 'diredp-do-aggregate-apply-to-marked "dired+" "\
...
(fn AGGREGATE-FUN &optional MARK-ARG MSGP)" t)
(autoload 'diredp-do-aggregate-eval-in-marked "dired+" "\
...
(fn AGGREGATE-FUN &optional MARK-ARG MSGP)" t)
(autoload 'diredp-do-apply-to-marked "dired+" "\
...
(fn FUNCTION &optional ARG)" t)
(autoload 'diredp-do-command-in-marked "dired+" "\
...
(autoload 'diredp-do-eval-in-marked "dired+" "\
...
(fn SEXP &optional ARG)" t)
(autoload 'diredp-do-apply/eval-marked "dired+" "\
...
(fn REGEXP &optional ARG INTERACTIVEP)" t)
...
(fn FROM TO &optional ARG INTERACTIVEP)" t)
(autoload 'dired-do-find-regexp-and-replace "dired+" "\
...
(fn DIRNAME &optional ARG NO-ERROR-IF-NOT-DIR-P)" t)
(autoload 'diredp-hide-subdir-nomove "dired+" "\
...
(fn ARG &optional NO-ERROR-IF-NOT-FOUND NO-SKIP)" t)
...
(fn &optional ARG)" t)
(autoload 'dired-repeat-over-lines "dired+" "\
...
(fn REGEXP &optional MARKER-CHAR NAME-FORM)" t)
...
(fn REGEXP &optional MARKER-CHAR)" t)
...
(fn &optional USE-TRASH-CAN)" t)
(autoload 'diredp-capitalize-this-file "dired+" "\
In Dired, rename this file by capitalizing it.
Makes the first char of the name uppercase and the others lowercase." t)
(autoload 'diredp-downcase-this-file "dired+" "\
In Dired, rename this file to lower case." t)
(autoload 'diredp-upcase-this-file "dired+" "\
In Dired, rename this file to upper case." t)
...
To move it, rename the directory part of its absolute name." t)
(autoload 'diredp-copy-this-file "dired+" "\
In Dired, copy this file." t)
(autoload 'diredp-relsymlink-this-file "dired+" "\
In Dired, make a relative symbolic link to file on cursor line." t)
(autoload 'diredp-symlink-this-file "dired+" "\
In Dired, make a symbolic link to this file." t)
(autoload 'diredp-hardlink-this-file "dired+" "\
In Dired, add a name (hard link) to this file." t)
(autoload 'diredp-print-this-file "dired+" "\
In Dired, print this file." t)
(autoload 'diredp-grep-this-file "dired+" "\
In Dired, grep this file." t)
(autoload 'diredp-compress-this-file "dired+" "\
In Dired, compress or uncompress this file." t)
...
(fn TAG VALUE &optional PREFIX MSGP)" t)
...
(fn &optional INTERNAL-FORM-P INTERACTIVEP DETAILS)" t)
(autoload 'diredp-byte-compile-this-file "dired+" "\
In Dired, byte compile the (Lisp source) file on the cursor line." t)
(autoload 'diredp-load-this-file "dired+" "\
In Dired, load this file." t)
(autoload 'diredp-chmod-this-file "dired+" "\
In Dired, change the mode of this file." t)
...
(fn PREDICATE &optional UNMARK-P)" t)
(autoload 'diredp-mark "dired+" "\
...
(fn &optional MARK-P)" t)
(autoload 'diredp-flag-region-files-for-deletion "dired+" "\
Flag all of the files in the current region (if it is active) for deletion." t)
...
In Dired, visit this file or directory in another frame." t)
...
Send a bug report about a Dired+ problem." t)
...
windows there, then delete its window (toggle : show/hide the file)." t)
