...

;;; Generated autoloads from debbugs-bookmarks.el

(autoload 'debbugs-gnu-bookmark-make-record "debbugs-bookmarks" "\
Make record used to bookmark a Debbugs buffer.
This implements the `bookmark-make-record-function' type for
such buffers.")
(autoload 'debbugs-gnu-bookmark-jump "debbugs-bookmarks" "\
Provide the `bookmark-jump' behavior for a Debbugs buffer.
This implements the `handler' function interface for the record
type returned by `debbugs-gnu-bookmark-make-record'.

(fn BMK)")
(register-definition-prefixes "debbugs-bookmarks" '("debbugs-gnu-bookmark-name"))
...
(register-definition-prefixes "debbugs-compat" '("debbugs-compat-"))
...
(autoload 'debbugs-gnu-show-last-result "debbugs-gnu" "\
Switch to buffer with the recent retrieved bugs." t)
...
This is a minor mode.  If called interactively, toggle the `Debbugs-Org
...
evaluate the variable `debbugs-org-mode'.
