;;; org-board-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
added as a link in the `ARCHIVED_AT' property." t)
...
attachments to the entry are deleted." t)
