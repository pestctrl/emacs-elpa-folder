...
Toggle Magit-Wip-After-Save-Local mode in many buffers.
Specifically, Magit-Wip-After-Save-Local mode is enabled in all
buffers where `magit-wip-after-save-local-mode-turn-on' would do it.
